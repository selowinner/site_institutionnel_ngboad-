...
@Component({
  selector: 'app-partenaires-continental',
  templateUrl: './partenaires-continental.component.html',
  styleUrls: ['./partenaires-continental.component.css']
})
export class PartenairesContinentalComponent implements OnInit {
