...
@Component({
  selector: 'app-membres-continental',
  templateUrl: './membres-continental.component.html',
  styleUrls: ['./membres-continental.component.css']
})
export class MembresContinentalComponent implements OnInit {
